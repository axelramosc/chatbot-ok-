...
const SETTING_LABELS: Record<string, { label: string; hint?: string; multiline?: boolean }> = {
  ...
  address:              { label: "Saltillo — Dirección", hint: "Matriz. De aquí salen todos los envíos." },
  phone_1:              { label: "Saltillo — Teléfono Principal" },
  phone_2:              { label: "Saltillo — Teléfono Secundario" },
  hours:                { label: "Saltillo — Horario de Atención", multiline: true },
  maps_url:             { label: "Saltillo — Ubicación en Google Maps" },
  address_nl:           { label: "Guadalupe, N.L. — Dirección", hint: "Punto de venta y recolección. No se originan envíos desde aquí." },
  phone_nl:             { label: "Guadalupe, N.L. — Teléfono" },
  hours_nl:             { label: "Guadalupe, N.L. — Horario de Atención", multiline: true },
  maps_url_nl:          { label: "Guadalupe, N.L. — Ubicación en Google Maps" },
